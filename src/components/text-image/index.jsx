...
import spices from "@/images/products/spice-banner.jpg";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-lg text-gray-600 mt-4">
            Elevate your culinary experience with our handpicked organic spices. 
            Rich in flavor, ethically sourced, and crafted to perfection.
          </p>
          <Link href="/products">
