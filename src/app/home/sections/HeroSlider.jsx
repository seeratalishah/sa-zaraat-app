...
import slide1 from "@/images/general/slide1.jpeg";
import slide2 from "@/images/general/slide2.jpg";
import slide3 from "@/images/general/slide3.avif";
...
const slides = [
  {
    ...
    description:
      " Supplying premium seafood, fresh produce, spices, and more worldwide",
  },
  {
    id: 2,
    image: slide2,
          ...
          <SwiperSlide key={slide.id}>
            <div className="relative w-full h-full">
              ...
              <div className="absolute top-0 bottom-0 left-0 right-0 flex flex-col items-center justify-center bg-black bg-opacity-40 text-white text-center p-6">
                ...
                <h3 className="text-[#fff] text-xl leading-[100%] font-normal mt-4">
                  {slide.description}
                </h3>
              </div>
            </div>
